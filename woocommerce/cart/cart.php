			...
			<tr>
				<td colspan="6" class="actions">
					...
					<?php if ( wc_coupons_enabled() ) { ?>
						<button type="submit" class="button" id="update_button" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update qty', 'woocommerce' ); ?></button>
						<div class="coupon">
