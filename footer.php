    ...
    <div class="salmon-bg" id="prefooter-container">
        <div id="prefooter-menu-container">
            ...
            <div id="social-media-container">
                ...
                <a href="https://www.youtube.com/amateurcreatives">
                ...
                <a href="https://www.patreon.com/amateurcreatives">
                ...
                <a href="https://www.twitter.com/mayorofbluebell">
    ...
    <div class="black-bg" id="footer-container">
        <div id="actual-footer-container">
            ...
            <div id="actual-heroes">
                ...
                <p>developed by <a href="https://youtu.be/dQw4w9WgXcQ?t=43" target="blank_">nico baguio</a> &copy <?php echo date("Y"); ?></p>
            </div>
        </div>
    </div>
</footer>
